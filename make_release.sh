...
if [[ -n "$GITHUB_TOKEN" ]]; then
    ...
    RELEASE_RESPONSE=$(curl -s -L -X POST \
        ...
        https://api.github.com/repos/vinitkumargoel/OpenSuperWhisper-v2/releases \
        -d '{
    ...
    UPLOAD_RESPONSE=$(curl -s -L -X POST \
        ...
        "https://uploads.github.com/repos/vinitkumargoel/OpenSuperWhisper-v2/releases/${RELEASE_ID}/assets?name=OpenSuperWhisper.dmg" \
    ...
    if [[ -n "$DSYM_ZIP_PATH" && -f "$DSYM_ZIP_PATH" ]]; then
        ...
        DSYM_UPLOAD_RESPONSE=$(curl -s -L -X POST \
            ...
            "https://uploads.github.com/repos/vinitkumargoel/OpenSuperWhisper-v2/releases/${RELEASE_ID}/assets?name=OpenSuperWhisper.app.dSYM.zip" \
    ...
    echo "🔗 Release URL: https://github.com/vinitkumargoel/OpenSuperWhisper-v2/releases/tag/${NEW_VERSION}"
else
    echo "⚠️ Skipping GitHub release creation (no token provided)"
    echo "📋 Manual steps needed:"
    echo "1. Create GitHub release at:"
    echo "   https://github.com/vinitkumargoel/OpenSuperWhisper-v2/releases/new?tag=${NEW_VERSION}"
...
cask "opensuperwhisper" do
  ...
  url "https://github.com/vinitkumargoel/OpenSuperWhisper-v2/releases/download/#{version}/OpenSuperWhisper.dmg"
  name "OpenSuperWhisper"
  desc "Whisper dictation/transcription app"
  homepage "https://github.com/vinitkumargoel/OpenSuperWhisper-v2"
  ...
  zap trash: [
    "~/Library/Application Scripts/com.vinitkumargoel.OpenSuperWhisperV2",
    "~/Library/Application Support/com.vinitkumargoel.OpenSuperWhisperV2",
  ]
end
EOF
echo "-----" 